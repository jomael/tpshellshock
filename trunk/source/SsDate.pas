...
{*********************************************************}
{* ShellShock: SsDate.pas 1.02                           *}
{*********************************************************}
{* ShellShock: Date and time manipulation                *}
{*********************************************************}
...
function Convert2ByteDate(TwoByteDate : Word) : TStDate;
  {-Convert an Object Professional two byte date into a ShellShock date}

function Convert4ByteDate(FourByteDate : TStDate) : Word;
  {-Convert a ShellShock date into an Object Professional two byte date}
